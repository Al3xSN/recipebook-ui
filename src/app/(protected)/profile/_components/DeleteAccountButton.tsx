  ...
  return (
    <>
      <button
        ...
        className="w-full text-center text-sm text-[var(--text3)] transition-colors hover:text-red-500"
      >
        Delete account
      </button>
          ...
          <div className="relative w-full max-w-sm rounded-2xl bg-white p-6 shadow-xl">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 rounded-xl border border-[var(--border)] py-2.5 text-sm font-medium text-[var(--text2)] transition-colors hover:bg-[var(--bg2)]"
              >
                Cancel
              </button>
              <button
